...
# SES Configuration
SES_SENDER_EMAIL = "gas-power-data-analytics-dev-datalake-alerts@yoyo.com"
...
def send_ses_notification(stack_name, resource_name, user_sso, aws_account_type, federated_role, agent, event_type, user_email, event_time):
    ...
    try:
        ...
        to_recipients = [
            user_email,
            "kamaldeep.nain@yoyo.com",
            "prakash.kancham@yoyo.com",
            "vinayak.patil12@yoyo.com",
            "mahesh.bandi1@yoyo.com",
            "amarnath.mansali@yoyo.com",
            "satishbabu.malluri@yoyo.com",
            "shivam.sharma1@yoyo.com",
            "goutham.p@yoyo.com",
	    "shahnawaz.alam1@yoyo.com",
	    "sarita.kushwaha@yoyo.com"
        ]
        ...
        <body>
            ...
            <p style="font-size: 15px;text-align: center;"><b>*The rules and regulations for creating High Trust VPC compliant AWS objects have been documented in a <a href="https://devcloud.swcoe.yoyo.com/devspace/pages/viewpage.action?spaceKey=SIP&title=Security+Guidelines+for+creating+resources+in+Gas+Power+datalake+VPC" target="_blank">Confluence Page</a></b></p>
            <p style="font-size: 15px;text-align: center;"><b>*Please refer to this <a href="https://dev-tableau.cloud.digital.yoyo.com/t/Power/views/OpsGuardianDev/AccountLevelComplianceOverview?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link" target="_blank">central dashboard</a> to view all the changes related to VPC and activites on the Aurora Database Instances</b></p>
        </body>
        </html>
        """
