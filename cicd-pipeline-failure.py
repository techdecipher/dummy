...
def lambda_handler(event, context):
    ...
    response = ses_client.send_email(
        Source='user@testdomain.com',  # Replace with a verified SES email address as From address
        Destination={
            'ToAddresses': ['pranav.chaudhari@testdomain.com']  # Replace with the To email address
        },
        Message={
